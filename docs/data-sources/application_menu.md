...
page_title: "servicenow_application_menu Data Source - servicenow"
subcategory: ""
description: |-
  servicenow_application_menu data source can be used to retrieve information of a single application menu in ServiceNow by title.
---

# servicenow_application_menu (Data Source)
...
```terraform
# Look up an existing application menu in ServiceNow by title.
data "servicenow_application_menu" "example" {
