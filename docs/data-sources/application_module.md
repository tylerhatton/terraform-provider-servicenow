...
page_title: "servicenow_application_module Data Source - servicenow"
subcategory: ""
description: |-
  servicenow_application_module data source can be used to retrieve information of a single application module in ServiceNow by title.
---

# servicenow_application_module (Data Source)
...
```terraform
# Look up an existing application module in ServiceNow by title.
data "servicenow_application_module" "example" {
  title = "My Module"
}
```
