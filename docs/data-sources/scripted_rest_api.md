...
page_title: "servicenow_scripted_rest_api Data Source - servicenow"
subcategory: ""
description: |-
  servicenow_scripted_rest_api data source can be used to retrieve information of a single scripted REST API in ServiceNow by name.
---

# servicenow_scripted_rest_api (Data Source)
