...
page_title: "servicenow_service_catalog_item Resource - servicenow"
subcategory: ""
description: |-
  servicenow_service_catalog_item manages a service catalog item configuration within ServiceNow.
---
...
terraform import servicenow_service_catalog_item.example <sys_id>
```
